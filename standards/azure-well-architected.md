...
| **Availability zones** | Deploy stateless workloads across availability zones where supported. Use zone-redundant configurations for Azure services (AKS, DocumentDB, Blob Storage). |
